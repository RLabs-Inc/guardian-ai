...
export class IndexingAgent {
  ...
  /**
   * Logs memory usage at a specific checkpoint and optionally forces garbage collection
   */
  public performMemoryCheckpoint(checkpointName: string, details: Record<string, any> = {}, forceGC: boolean = true): void {
    ...
    // If snapshot list is getting too large, clear it to prevent memory bloat
